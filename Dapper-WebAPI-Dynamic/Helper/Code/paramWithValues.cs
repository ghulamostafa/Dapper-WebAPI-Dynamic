...
namespace Dapper_WebAPI_Dynamic.Helper.Code
{
    ...
    public class paramWithValues
    {
        ...
        /// </summary>
        public DataTable valueDT { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Param of decimal type
        /// </summary>
        /// <param name="_param"></param>
        /// <param name="_value"></param>
        /// <param name="_paramDirection"></param>
        /// <param name="_dbType"></param>
        public paramWithValues(string _param, decimal _value, ParameterDirection _paramDirection = ParameterDirection.Input, DbType _dbType = DbType.String)
        {
            param = _param;
            value = _value.ToString();
            paramDirection = _paramDirection;
        ...
        public paramWithValues(string _param, DataTable _value, ParameterDirection _paramDirection = ParameterDirection.Input, DbType _dbType = DbType.Object)
        {
            param = _param;
            valueDT = _value;
            paramDirection = _paramDirection;
